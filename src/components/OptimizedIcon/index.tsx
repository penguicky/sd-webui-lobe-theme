 ...
 */
import { type FC, type RefAttributes, type SVGProps, forwardRef, memo } from 'react';
...
const iconPaths = {
  ...
  'brush':
    'M9.06 11.9c.18-.19.45-.3.74-.3h4.4c.29 0 .56.11.74.3l2.36 2.36a1 1 0 010 1.42l-2.36 2.36c-.18.18-.45.3-.74.3H9.8c-.29 0-.56-.12-.74-.3L6.7 15.68a1 1 0 010-1.42L9.06 11.9zM12 5L8 9l4 4 4-4-4-4z',
  'bug':
    'M8 2v4M16 2v4M8 14v.01M16 14v.01M12 6v.01M8 10v.01M16 10v.01M12 14v.01M20 8a8 8 0 11-16 0 8 8 0 0116 0z',
  'chevron-down': 'M6 9l6 6 6-6',
  'chevron-right': 'M9 18l6-6-6-6',
  'file-clock':
    'M16 22h2a2 2 0 002-2V7.5L14.5 2H6a2 2 0 00-2 2v3M14 2v6h6M10 15.5a2.5 2.5 0 105 0 2.5 2.5 0 00-5 0zM12.5 13v2.5L14 17',
  'flask-conical': 'M10 2v7.31l-3.39 6.78a1 1 0 00.9 1.41h9.98a1 1 0 00.9-1.41L14 9.31V2M8 2h8',
  'git-fork':
    'M6 3v12M18 9a3 3 0 100-6 3 3 0 000 6zM6 21a3 3 0 100-6 3 3 0 000 6zM18 15v6M6 9a9 9 0 009 9',
  'github':
  ...
  'palette':
    'M12 2C6.49 2 2 6.49 2 12s4.49 10 10 10c1.38 0 2.5-.56 2.5-1.25 0-.34-.13-.65-.35-.88-.22-.23-.35-.54-.35-.87 0-.69.56-1.25 1.25-1.25H16c3.31 0 6-2.69 6-6 0-5.51-4.49-10-10-10zM7.5 9a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zM12 5.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zM16.5 9a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z',
  'panel-left-close': 'M9 6l6 6-6 6M3 3h18v18H3z',
  'panel-right': 'M2 3h20v18H2zM15 8v8',
  'panel-right-close': 'M15 18l-6-6 6-6M3 3h18v18H3z',
  'refresh-cw':
    'M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8M3 16l2.26-2.26A9.75 9.75 0 0 0 12 21a9 9 0 0 1 9-9',
  'settings':
  ...
  'sun':
    'M12 1v2M12 21v2m9-9h2M1 12h2m15.36-6.36l1.42-1.42M6.64 6.64L5.22 5.22m12.72 12.72l1.42 1.42M6.64 17.36l-1.42 1.42M16 12a4 4 0 11-8 0 4 4 0 018 0z',
  'text-cursor-input':
    'M5 4h1a3 3 0 013 3 3 3 0 013-3h1M13 20h-1a3 3 0 01-3-3 3 3 0 01-3 3H5M5 16H4a2 2 0 01-2-2v-4a2 2 0 012-2h1M13 4h7v16h-7M9 7v10',
