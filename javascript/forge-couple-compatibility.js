...
(function() {
    ...
    // List of sd-forge-couple selectors that should never be hidden
            ...
            mutations.forEach(function(mutation) {
                if (mutation.type === 'attributes' && mutation.attributeName === 'style') {
                    ...
                    if (target.nodeType === Node.ELEMENT_NODE) {
                        ...
                        // Check if this element matches any forge-couple selector
                        const isForgeCouple = FORGE_COUPLE_SELECTORS.some(selector => {
                        ...
                        if (isForgeCouple && element.style.display === 'none') {
                            console.log(`[Lobe Theme Compatibility] Preventing hide of forge-couple element:`, element);
                            element.style.display = '';
                            element.style.visibility = 'visible';
                            element.style.opacity = '1';
                        }
    ...
    function waitForExtensions() {
        ...
        const checkInterval = setInterval(() => {
            ...
            const hasLobeTheme = document.querySelector('.ant-app') !== null || 
            ...
            if (hasForgeCouple || attempts >= maxAttempts) {
                ...
                if (hasForgeCouple) {
                    console.log('[Lobe Theme Compatibility] sd-forge-couple detected, initializing compatibility');
                    initCompatibility();
                } else {
                    console.log('[Lobe Theme Compatibility] sd-forge-couple not detected, skipping compatibility fixes');
                }
            }
        }, 200);
    }
